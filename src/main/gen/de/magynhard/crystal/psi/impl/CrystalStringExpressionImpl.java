...
public class CrystalStringExpressionImpl extends CrystalStringExpressionMixin implements CrystalStringExpression {

  public CrystalStringExpressionImpl(ASTNode node) {
    super(node);
  }

...
public class CrystalModuleDefinitionImpl extends ASTWrapperPsiElement implements CrystalModuleDefinition {

  public CrystalModuleDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

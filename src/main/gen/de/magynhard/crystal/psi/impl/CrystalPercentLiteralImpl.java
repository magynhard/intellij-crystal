...
public class CrystalPercentLiteralImpl extends CrystalPercentLiteralMixin implements CrystalPercentLiteral {

  public CrystalPercentLiteralImpl(ASTNode node) {
    super(node);
  }

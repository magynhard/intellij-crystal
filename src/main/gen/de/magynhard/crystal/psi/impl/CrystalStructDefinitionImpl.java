...
public class CrystalStructDefinitionImpl extends ASTWrapperPsiElement implements CrystalStructDefinition {

  public CrystalStructDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

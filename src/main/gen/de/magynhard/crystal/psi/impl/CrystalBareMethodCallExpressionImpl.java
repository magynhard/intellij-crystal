...
public class CrystalBareMethodCallExpressionImpl extends ASTWrapperPsiElement implements CrystalBareMethodCallExpression {

  public CrystalBareMethodCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

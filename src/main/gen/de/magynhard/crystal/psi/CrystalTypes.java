...
public interface CrystalTypes {
  ...
  IElementType CLASS_DEFINITION = new CrystalElementType("CLASS_DEFINITION");
  ...
  IElementType ENUM_DEFINITION = new CrystalElementType("ENUM_DEFINITION");
  ...
  IElementType MACRO_DEFINITION = new CrystalElementType("MACRO_DEFINITION");
  ...
  IElementType METHOD_DEFINITION = new CrystalElementType("METHOD_DEFINITION");
  IElementType METHOD_NAME = new CrystalElementType("METHOD_NAME");
  IElementType MODULE_DEFINITION = new CrystalElementType("MODULE_DEFINITION");
  ...
  IElementType STRUCT_DEFINITION = new CrystalElementType("STRUCT_DEFINITION");

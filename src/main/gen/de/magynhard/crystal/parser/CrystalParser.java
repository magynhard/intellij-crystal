...
public class CrystalParser implements PsiParser, LightPsiParser {
  ...
  private static boolean argument_3(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = argument_3_0(builder_, level_ + 1);
    result_ = result_ && expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [IDENTIFIER COLON]
  private static boolean argument_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "argument_3_0")) return false;
    parseTokens(builder_, 0, IDENTIFIER, COLON);
    return true;
  }

  /* ********************************************************** */
  // argument (NLS COMMA NLS argument)*
  ...
  /* ********************************************************** */
  // variable assign_op (assignment | expression) [postfix_modifier]
  public static boolean assignment(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && assignment_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // bare_range_expression ((EQ | NEQ | LT | GT | LTE | GTE | SPACESHIP | CASE_EQ | MATCH_OP) bare_range_expression)*
  ...
  // ((EQ | NEQ | LT | GT | LTE | GTE | SPACESHIP | CASE_EQ | MATCH_OP) bare_range_expression)*
  ...
  /* ********************************************************** */
  // DOT (AS | AS_QUESTION | IS_A) LPAREN type_reference RPAREN
  //                           | DOT (IDENTIFIER | CONSTANT | keyword_as_method) [call_args]
  ...
  private static boolean bare_postfix_op_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, DOT);
    result_ = result_ && bare_postfix_op_1_1(builder_, level_ + 1);
  ...
  private static boolean bare_postfix_op_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_postfix_op_1_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
  ...
  private static boolean bare_range_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && bare_range_expression_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean bare_range_expression_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_range_expression_1_0_1")) return false;
  ...
  /* ********************************************************** */
  // DO [PIPE parameter_list PIPE] statement_list rescue_clause* [else_clause] [ensure_clause] END
  ...
  public static boolean break_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && break_statement_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // range_expression ((EQ | NEQ | LT | GT | LTE | GTE | SPACESHIP | CASE_EQ | MATCH_OP) range_expression)*
  ...
  // ((EQ | NEQ | LT | GT | LTE | GTE | SPACESHIP | CASE_EQ | MATCH_OP) range_expression)*
  ...
  /* ********************************************************** */
  // CONSTANT ASSIGN expression [postfix_modifier]
  public static boolean constant_assignment(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && constant_assignment_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  // [postfix_modifier]
  private static boolean constant_assignment_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "constant_assignment_3")) return false;
    postfix_modifier(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // multi_assign_target COMMA multi_assign_target_list ASSIGN multi_assign_values
  ...
  public static boolean next_statement(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, next_statement_1(builder_, level_ + 1));
    result_ = pinned_ && next_statement_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // OFFSETOF LPAREN type_reference COMMA instance_var_access RPAREN
  ...
  /* ********************************************************** */
  // [parameter_item (COMMA NLS parameter_item)*]
  ...
  /* ********************************************************** */
  // DOT (AS | AS_QUESTION | IS_A) LPAREN type_reference RPAREN
  //                      | DOT (IDENTIFIER | CONSTANT | keyword_as_method) [call_args | bare_argument_list] [block]
  //                      | DOUBLE_COLON CONSTANT
  //                      | LBRACKET argument_list RBRACKET
  //                      | call_args [block]
  ...
  private static boolean postfix_op_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, DOT);
    result_ = result_ && postfix_op_1_1(builder_, level_ + 1);
  ...
  // IDENTIFIER | CONSTANT | keyword_as_method
  private static boolean postfix_op_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "postfix_op_1_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    if (!result_) result_ = keyword_as_method(builder_, level_ + 1);
  ...
  private static boolean postfix_op_1_2(PsiBuilder builder_, int level_) {
    ...
    postfix_op_1_2_0(builder_, level_ + 1);
    return true;
  }

  // call_args | bare_argument_list
  private static boolean postfix_op_1_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "postfix_op_1_2_0")) return false;
    boolean result_;
  ...
  private static boolean range_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && range_expression_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean range_expression_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "range_expression_1_0_1")) return false;
  ...
  public static boolean return_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && return_statement_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // LPAREN type_argument (COMMA type_argument)* RPAREN
  ...
  private static boolean type_single_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && type_single_0_1(builder_, level_ + 1);
  ...
  // [type_arguments]
  private static boolean type_single_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_single_0_1")) return false;
  ...
  private static boolean type_single_1_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_single_1_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_single_1_2", pos_)) break;
    }
    return true;
  }

  // COMMA type_reference
  private static boolean type_single_1_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_single_1_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  private static boolean type_single_2_5(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_single_2_5_0(builder_, level_ + 1)) break;
  ...
  private static boolean type_single_3_3(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_single_3_3_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_single_3_3", pos_)) break;
    }
    return true;
  }

  // NLS COMMA NLS type_reference
  private static boolean type_single_3_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_single_3_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = NLS(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);

...
import static de.magynhard.crystal.parser.CrystalParserPredicates.*;
...
public class CrystalParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // abrupt_value (COMMA NLS abrupt_value)*
  static boolean abrupt_value_list(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "abrupt_value_list")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = abrupt_value(builder_, level_ + 1);
    result_ = result_ && abrupt_value_list_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (COMMA NLS abrupt_value)*
  private static boolean abrupt_value_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "abrupt_value_list_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!abrupt_value_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "abrupt_value_list_1", pos_)) break;
    }
    return true;
  }

  // COMMA NLS abrupt_value
  private static boolean abrupt_value_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "abrupt_value_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && abrupt_value(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  /* ********************************************************** */
  // &DOUBLE_COLON expression
  static boolean absolute_namespace_bare_expression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "absolute_namespace_bare_expression")) return false;
    if (!nextTokenIs(builder_, DOUBLE_COLON)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = absolute_namespace_bare_expression_0(builder_, level_ + 1);
  ...
  // &DOUBLE_COLON
  private static boolean absolute_namespace_bare_expression_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "absolute_namespace_bare_expression_0")) return false;
    boolean result_;
  ...
  /* ********************************************************** */
  // comparison_expression (AND_AND NLS comparison_expression)*
  static boolean and_expression(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = comparison_expression(builder_, level_ + 1);
    result_ = result_ && and_expression_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (AND_AND NLS comparison_expression)*
  ...
  /* ********************************************************** */
  // call_argument (macro_argument_trivia COMMA call_argument)* [macro_argument_trivia COMMA] macro_argument_trivia
  ...
  private static boolean argument_list_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = call_argument(builder_, level_ + 1);
  ...
  // (macro_argument_trivia COMMA call_argument)*
  ...
  private static boolean argument_list_0_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_argument(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean argument_list_0_2(PsiBuilder builder_, int level_) {
    ...
    argument_list_0_2_0(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // array_type_declaration | expression
  static boolean array_element(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = array_type_declaration(builder_, level_ + 1);
    if (!result_) result_ = expression(builder_, level_ + 1);
    return result_;
  }

  /* ********************************************************** */
  // macro_argument_trivia array_element (macro_argument_trivia COMMA macro_argument_trivia array_element)* [COMMA macro_argument_trivia]
  public static boolean array_element_list(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_element_list")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, EXPRESSION_LIST, "<array element list>");
    result_ = macro_argument_trivia(builder_, level_ + 1);
    result_ = result_ && array_element(builder_, level_ + 1);
    result_ = result_ && array_element_list_2(builder_, level_ + 1);
    result_ = result_ && array_element_list_3(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // (macro_argument_trivia COMMA macro_argument_trivia array_element)*
  private static boolean array_element_list_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!array_element_list_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "array_element_list_2", pos_)) break;
    }
    return true;
  }

  // macro_argument_trivia COMMA macro_argument_trivia array_element
  private static boolean array_element_list_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_element_list_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_argument_trivia(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
  ...
  private static boolean array_element_list_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_element_list_3")) return false;
    array_element_list_3_0(builder_, level_ + 1);
    return true;
  }

  // COMMA macro_argument_trivia
  private static boolean array_element_list_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_element_list_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // LBRACKET NLS [array_element_list] NLS RBRACKET [OF type_reference]
  ...
  /* ********************************************************** */
  // (instance_var_access | class_var_access | IDENTIFIER) COLON type_reference [ASSIGN expression]
  public static boolean array_type_declaration(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_type_declaration")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, PROPERTY_DECLARATION, "<array type declaration>");
    result_ = array_type_declaration_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COLON);
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && array_type_declaration_3(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // instance_var_access | class_var_access | IDENTIFIER
  private static boolean array_type_declaration_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_type_declaration_0")) return false;
    boolean result_;
  ...
  // [ASSIGN expression]
  private static boolean array_type_declaration_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_type_declaration_3")) return false;
    array_type_declaration_3_0(builder_, level_ + 1);
    return true;
  }

  // ASSIGN expression
  private static boolean array_type_declaration_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_type_declaration_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // variable assign_op NLS (assignment | nested_indexed_assignment | expression) [postfix_modifier] [heredoc_bodies]
  ...
  static boolean assignment_target(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = class_var_access(builder_, level_ + 1);
    if (!result_) result_ = assignment_target_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [DOUBLE_COLON] CONSTANT (DOUBLE_COLON CONSTANT)*
  private static boolean assignment_target_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_target_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = assignment_target_4_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, CONSTANT);
    result_ = result_ && assignment_target_4_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [DOUBLE_COLON]
  private static boolean assignment_target_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_target_4_0")) return false;
    consumeToken(builder_, DOUBLE_COLON);
    return true;
  }

  // (DOUBLE_COLON CONSTANT)*
  private static boolean assignment_target_4_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_target_4_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!assignment_target_4_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "assignment_target_4_2", pos_)) break;
    }
    return true;
  }

  // DOUBLE_COLON CONSTANT
  private static boolean assignment_target_4_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_target_4_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // bare_comparison_expression (AND_AND NLS bare_comparison_expression)*
  static boolean bare_and_expression(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_comparison_expression(builder_, level_ + 1);
    result_ = result_ && bare_and_expression_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (AND_AND NLS bare_comparison_expression)*
  ...
  private static boolean bare_and_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, AND_AND);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && bare_comparison_expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  //                 | &<<isBlockPassAllowed>> AMPERSAND bare_expression
  //                 | assignment
  //                 | bare_expression
  public static boolean bare_argument(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = named_type_bare_argument(builder_, level_ + 1);
    if (!result_) result_ = named_bare_argument(builder_, level_ + 1);
  ...
  private static boolean bare_argument_5(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_argument_5_0(builder_, level_ + 1);
  ...
  // &<<isBlockPassAllowed>>
  private static boolean bare_argument_5_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_argument_5_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isBlockPassAllowed(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  /* ********************************************************** */
  // bare_argument (macro_argument_trivia COMMA macro_argument_trivia [interleaved_heredoc_bodies macro_argument_trivia] bare_argument)* [COMMA macro_argument_trivia]
  public static boolean bare_argument_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && bare_argument_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // (macro_argument_trivia COMMA macro_argument_trivia [interleaved_heredoc_bodies macro_argument_trivia] bare_argument)*
  ...
  private static boolean bare_argument_list_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
    result_ = result_ && bare_argument_list_1_0_3(builder_, level_ + 1);
    result_ = result_ && bare_argument(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [interleaved_heredoc_bodies macro_argument_trivia]
  private static boolean bare_argument_list_1_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_argument_list_1_0_3")) return false;
    bare_argument_list_1_0_3_0(builder_, level_ + 1);
    return true;
  }

  // interleaved_heredoc_bodies macro_argument_trivia
  private static boolean bare_argument_list_1_0_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_argument_list_1_0_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = interleaved_heredoc_bodies(builder_, level_ + 1);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [COMMA macro_argument_trivia]
  private static boolean bare_argument_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_argument_list_2")) return false;
    bare_argument_list_2_0(builder_, level_ + 1);
    return true;
  }

  // COMMA macro_argument_trivia
  private static boolean bare_argument_list_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_argument_list_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // IDENTIFIER | CONSTANT | IS_A | RESPONDS_TO
  static boolean bare_call_callee(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_call_callee")) return false;
    boolean result_;
  ...
  /* ********************************************************** */
  // bare_or_expression [QUESTION NLS expression NLS COLON NLS expression | QUESTION [expression COLON expression]]
  ...
  // [QUESTION NLS expression NLS COLON NLS expression | QUESTION [expression COLON expression]]
  ...
  private static boolean bare_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_expression_1_0_0(builder_, level_ + 1);
    if (!result_) result_ = bare_expression_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // QUESTION NLS expression NLS COLON NLS expression
  private static boolean bare_expression_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_expression_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  private static boolean bare_expression_1_0_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, QUESTION);
    result_ = result_ && bare_expression_1_0_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [expression COLON expression]
  private static boolean bare_expression_1_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_expression_1_0_1_1")) return false;
    bare_expression_1_0_1_1_0(builder_, level_ + 1);
    return true;
  }

  // expression COLON expression
  private static boolean bare_expression_1_0_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_expression_1_0_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // bare_call_callee !<<isTokenTightAfterPreviousToken>> loose_grouped_postfix_argument_list
  //                                | bare_call_callee call_args
  ...
  //                               | bare_call_callee !DOT !LBRACKET !<<isDotBareArgsBinaryOp>> !DOTDOT !DOTDOTDOT !<<isHeredocBodyOpener>> bare_argument_list
  //                               | bare_call_callee !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list
  //                               // Loose (whitespace-separated) bare array argument with
  //                               // no comma (`parse_args [\n ... \n]`); the tight `[`
  //                               // stays on the index postfix path.
  //                               | bare_call_callee !DOT !LBRACE !<<isDotBareArgsBinaryOp>> !DOTDOT !DOTDOTDOT !<<isTokenTightAfterPreviousToken>> !<<isHeredocBodyOpener>> bare_argument_list
  public static boolean bare_method_call_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = bare_method_call_expression_1(builder_, level_ + 1);
    if (!result_) result_ = bare_method_call_expression_2(builder_, level_ + 1);
    if (!result_) result_ = bare_method_call_expression_3(builder_, level_ + 1);
    if (!result_) result_ = bare_method_call_expression_4(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean bare_method_call_expression_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_call_callee(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_0_1(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !<<isTokenTightAfterPreviousToken>>
  private static boolean bare_method_call_expression_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // bare_call_callee !DOT !LBRACKET !<<isDotBareArgsBinaryOp>> !DOTDOT !DOTDOTDOT !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean bare_method_call_expression_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_call_callee(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_1(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_2(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_3(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_4(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_5(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_2_6(builder_, level_ + 1);
  ...
  // !DOT
  private static boolean bare_method_call_expression_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !LBRACKET
  private static boolean bare_method_call_expression_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean bare_method_call_expression_2_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !DOTDOT
  private static boolean bare_method_call_expression_2_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !DOTDOTDOT
  private static boolean bare_method_call_expression_2_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean bare_method_call_expression_2_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_2_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // bare_call_callee !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list
  private static boolean bare_method_call_expression_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_call_callee(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_3_1(builder_, level_ + 1);
    result_ = result_ && array_literal(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean bare_method_call_expression_3_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_3_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // bare_call_callee !DOT !LBRACE !<<isDotBareArgsBinaryOp>> !DOTDOT !DOTDOTDOT !<<isTokenTightAfterPreviousToken>> !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean bare_method_call_expression_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_call_callee(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_1(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_2(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_3(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_4(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_5(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_6(builder_, level_ + 1);
    result_ = result_ && bare_method_call_expression_4_7(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !DOT
  private static boolean bare_method_call_expression_4_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean bare_method_call_expression_4_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !<<isDotBareArgsBinaryOp>>
  private static boolean bare_method_call_expression_4_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isDotBareArgsBinaryOp(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !DOTDOT
  private static boolean bare_method_call_expression_4_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOTDOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !DOTDOTDOT
  private static boolean bare_method_call_expression_4_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOTDOTDOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean bare_method_call_expression_4_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean bare_method_call_expression_4_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_method_call_expression_4_7")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  static boolean bare_range_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = bare_range_expression_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean bare_range_expression_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && bare_range_expression_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [(DOTDOT | DOTDOTDOT) [bare_or_bitwise_expression]]
  private static boolean bare_range_expression_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_range_expression_1_1")) return false;
    bare_range_expression_1_1_0(builder_, level_ + 1);
    return true;
  }

  // (DOTDOT | DOTDOTDOT) [bare_or_bitwise_expression]
  private static boolean bare_range_expression_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_range_expression_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_range_expression_1_1_0_0(builder_, level_ + 1);
    result_ = result_ && bare_range_expression_1_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // DOTDOT | DOTDOTDOT
  private static boolean bare_range_expression_1_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_range_expression_1_1_0_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, DOTDOT);
    if (!result_) result_ = consumeToken(builder_, DOTDOTDOT);
    return result_;
  ...
  // [bare_or_bitwise_expression]
  private static boolean bare_range_expression_1_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_range_expression_1_1_0_1")) return false;
    bare_or_bitwise_expression(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // (PLUS | MINUS | TILDE | STAR | BANG) bare_unary_expression
  //                                 | &<<isBlockPassAllowed>> AMPERSAND bare_unary_expression
  //                                 | &<<isWrapUnaryAllowed>> (WRAP_PLUS | WRAP_MINUS) bare_unary_expression
  ...
  static boolean bare_unary_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = bare_unary_expression_1(builder_, level_ + 1);
    if (!result_) result_ = bare_unary_expression_2(builder_, level_ + 1);
  ...
  // &<<isBlockPassAllowed>> AMPERSAND bare_unary_expression
  private static boolean bare_unary_expression_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_unary_expression_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_unary_expression_1_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, AMPERSAND);
    result_ = result_ && bare_unary_expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // &<<isBlockPassAllowed>>
  private static boolean bare_unary_expression_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_unary_expression_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isBlockPassAllowed(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // &<<isWrapUnaryAllowed>> (WRAP_PLUS | WRAP_MINUS) bare_unary_expression
  private static boolean bare_unary_expression_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_unary_expression_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_unary_expression_2_0(builder_, level_ + 1);
    result_ = result_ && bare_unary_expression_2_1(builder_, level_ + 1);
    result_ = result_ && bare_unary_expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isWrapUnaryAllowed>>
  private static boolean bare_unary_expression_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_unary_expression_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isWrapUnaryAllowed(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // WRAP_PLUS | WRAP_MINUS
  private static boolean bare_unary_expression_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "bare_unary_expression_2_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, WRAP_PLUS);
    if (!result_) result_ = consumeToken(builder_, WRAP_MINUS);
    return result_;
  }
  ...
  private static boolean block_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && block_0_2(builder_, level_ + 1);
  ...
  // [statement_list]
  private static boolean block_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "block_0_2")) return false;
  ...
  private static boolean block_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && block_1_2(builder_, level_ + 1);
  ...
  private static boolean break_statement_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, BREAK);
    result_ = result_ && abrupt_value_list(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // NLS macro_if_envelope | macro_argument_trivia argument
  static boolean call_argument(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "call_argument")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = call_argument_0(builder_, level_ + 1);
    if (!result_) result_ = call_argument_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // NLS macro_if_envelope
  private static boolean call_argument_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "call_argument_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = NLS(builder_, level_ + 1);
    result_ = result_ && macro_if_envelope(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // macro_argument_trivia argument
  private static boolean call_argument_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "call_argument_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_argument_trivia(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // IDENTIFIER | CONSTANT | SELECT | IS_A | RESPONDS_TO
  static boolean call_callee(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "call_callee")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
  ...
  private static boolean case_statement_1(PsiBuilder builder_, int level_) {
    ...
    case_subject(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // multi_assignment | assignment | constant_assignment | expression
  static boolean case_subject(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "case_subject")) return false;
    boolean result_;
  ...
  //                         | macro_conditional_method_definition
  //                         | method_definition
  //                         | macro_definition
  //                         | class_definition
  //                         | module_definition
  ...
  static boolean class_member(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = macro_conditional_method_definition(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // COMMAND_BEGIN (COMMAND_LITERAL | STRING_ESCAPE | interpolation_expression)* COMMAND_END
  ...
  // (COMMAND_LITERAL | STRING_ESCAPE | interpolation_expression)*
  ...
  /* ********************************************************** */
  // !<<colonHasLeadingDeclarationWhitespace>> COLON
  static boolean compact_colon(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "compact_colon")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = compact_colon_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COLON);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !<<colonHasLeadingDeclarationWhitespace>>
  private static boolean compact_colon_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "compact_colon_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !colonHasLeadingDeclarationWhitespace(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  //                               | OR_OR_ASSIGN | AND_AND_ASSIGN
  //                               | WRAP_PLUS_ASSIGN | WRAP_MINUS_ASSIGN | WRAP_STAR_ASSIGN | WRAP_DOUBLE_STAR_ASSIGN
  static boolean compound_assign_op(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "compound_assign_op")) return false;
    boolean result_;
    result_ = consumeToken(builder_, PLUS_ASSIGN);
    if (!result_) result_ = consumeToken(builder_, MINUS_ASSIGN);
    if (!result_) result_ = consumeToken(builder_, STAR_ASSIGN);
    if (!result_) result_ = consumeToken(builder_, SLASH_ASSIGN);
    if (!result_) result_ = consumeToken(builder_, PERCENT_ASSIGN);
  ...
  /* ********************************************************** */
  // variable assign_op NLS expression
  ...
  /* ********************************************************** */
  // CONSTANT ASSIGN NLS expression [postfix_modifier] [heredoc_bodies]
  public static boolean constant_assignment(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, constant_assignment_4(builder_, level_ + 1)) && result_;
    result_ = pinned_ && constant_assignment_5(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // [heredoc_bodies]
  private static boolean constant_assignment_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "constant_assignment_5")) return false;
    heredoc_bodies(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // RETURN [abrupt_value_list]
  //                                    | BREAK [abrupt_value_list]
  //                                    | NEXT [abrupt_value_list]
  static boolean control_flow_expression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = control_flow_expression_0(builder_, level_ + 1);
    if (!result_) result_ = control_flow_expression_1(builder_, level_ + 1);
    if (!result_) result_ = control_flow_expression_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // RETURN [abrupt_value_list]
  private static boolean control_flow_expression_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, RETURN);
    result_ = result_ && control_flow_expression_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [abrupt_value_list]
  private static boolean control_flow_expression_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_0_1")) return false;
    abrupt_value_list(builder_, level_ + 1);
    return true;
  }

  // BREAK [abrupt_value_list]
  private static boolean control_flow_expression_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, BREAK);
    result_ = result_ && control_flow_expression_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [abrupt_value_list]
  private static boolean control_flow_expression_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_1_1")) return false;
    abrupt_value_list(builder_, level_ + 1);
    return true;
  }

  // NEXT [abrupt_value_list]
  private static boolean control_flow_expression_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, NEXT);
    result_ = result_ && control_flow_expression_2_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [abrupt_value_list]
  private static boolean control_flow_expression_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_flow_expression_2_1")) return false;
    abrupt_value_list(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // if_statement | unless_statement | out_argument
  static boolean control_value(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "control_value")) return false;
    boolean result_;
  ...
  /* ********************************************************** */
  // DOT ( (IDENTIFIER | CONSTANT | keyword_as_method) macro_fragment_suffix*
  //                         | INSTANCE_VAR | CLASS_VAR | AT macro_interpolation | macro_interpolation
  //                         ) [&<<isTokenTightAfterPreviousToken>> QUESTION]
  //                             [!<<isTokenTightAfterPreviousToken>> loose_grouped_postfix_argument_list
  ...
  public static boolean dot_call_access(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && dot_call_access_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, DOT_CALL_ACCESS, result_);
    return result_;
  }

  // (IDENTIFIER | CONSTANT | keyword_as_method) macro_fragment_suffix*
  //                         | INSTANCE_VAR | CLASS_VAR | AT macro_interpolation | macro_interpolation
  private static boolean dot_call_access_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_1_0(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, INSTANCE_VAR);
    if (!result_) result_ = consumeToken(builder_, CLASS_VAR);
    if (!result_) result_ = dot_call_access_1_3(builder_, level_ + 1);
  ...
  // (IDENTIFIER | CONSTANT | keyword_as_method) macro_fragment_suffix*
  private static boolean dot_call_access_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_1_0_0(builder_, level_ + 1);
    result_ = result_ && dot_call_access_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // IDENTIFIER | CONSTANT | keyword_as_method
  private static boolean dot_call_access_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_1_0_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
  ...
  // macro_fragment_suffix*
  private static boolean dot_call_access_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_1_0_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_fragment_suffix(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "dot_call_access_1_0_1", pos_)) break;
    }
    return true;
  }
  ...
  private static boolean dot_call_access_2_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_2_0_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, QUESTION);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean dot_call_access_2_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_2_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean dot_call_access_3_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_0(builder_, level_ + 1);
    if (!result_) result_ = dot_call_access_3_0_1(builder_, level_ + 1);
    if (!result_) result_ = call_args(builder_, level_ + 1);
    if (!result_) result_ = dot_call_access_3_0_3(builder_, level_ + 1);
    if (!result_) result_ = dot_call_access_3_0_4(builder_, level_ + 1);
    if (!result_) result_ = dot_call_access_3_0_5(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !<<isTokenTightAfterPreviousToken>> loose_grouped_postfix_argument_list
  private static boolean dot_call_access_3_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_0_0(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean dot_call_access_3_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isTokenTightAfterPreviousToken>> call_args COMMA bare_argument_list
  private static boolean dot_call_access_3_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_1_0(builder_, level_ + 1);
    result_ = result_ && call_args(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean dot_call_access_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !DOT !LBRACKET !LBRACE !<<isDotBareArgsBinaryOp>> !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean dot_call_access_3_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_3_0(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_3_1(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_3_2(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_3_3(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_3_4(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !DOT
  private static boolean dot_call_access_3_0_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACKET
  private static boolean dot_call_access_3_0_3_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean dot_call_access_3_0_3_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isDotBareArgsBinaryOp>>
  private static boolean dot_call_access_3_0_3_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isDotBareArgsBinaryOp(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean dot_call_access_3_0_3_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_3_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !DOT !LBRACE !<<isDotBareArgsBinaryOp>> !<<isTokenTightAfterPreviousToken>> !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean dot_call_access_3_0_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_4_0(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_4_1(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_4_2(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_4_3(builder_, level_ + 1);
    result_ = result_ && dot_call_access_3_0_4_4(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !DOT
  private static boolean dot_call_access_3_0_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean dot_call_access_3_0_4_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isDotBareArgsBinaryOp>>
  private static boolean dot_call_access_3_0_4_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isDotBareArgsBinaryOp(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean dot_call_access_3_0_4_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean dot_call_access_3_0_4_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_4_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list
  private static boolean dot_call_access_3_0_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dot_call_access_3_0_5_0(builder_, level_ + 1);
    result_ = result_ && array_literal(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean dot_call_access_3_0_5_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dot_call_access_3_0_5_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  /* ********************************************************** */
  // or_expression [QUESTION NLS expression NLS COLON NLS expression | QUESTION [expression COLON expression]]
  ...
  private static boolean expression_1_0_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, QUESTION);
    result_ = result_ && expression_1_0_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [expression COLON expression]
  private static boolean expression_1_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expression_1_0_1_1")) return false;
    expression_1_0_1_1_0(builder_, level_ + 1);
    return true;
  }

  // expression COLON expression
  private static boolean expression_1_0_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expression_1_0_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = expression(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COLON);
  ...
  public static boolean expression_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && expression_list_3(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // (macro_argument_trivia COMMA macro_argument_trivia expression)*
  private static boolean expression_list_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!expression_list_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "expression_list_2", pos_)) break;
    }
    return true;
  }
  ...
  // [COMMA macro_argument_trivia]
  private static boolean expression_list_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expression_list_3")) return false;
    expression_list_3_0(builder_, level_ + 1);
    return true;
  }

  // COMMA macro_argument_trivia
  private static boolean expression_list_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expression_list_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // LPAREN NLS expression [assign_op NLS expression] (SEMICOLON NLS expression [assign_op NLS expression])* [postfix_modifier] NLS RPAREN
  ...
  // (SEMICOLON NLS expression [assign_op NLS expression])*
  private static boolean grouped_expression_4(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!grouped_expression_4_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "grouped_expression_4", pos_)) break;
    }
    return true;
  }
  ...
  private static boolean grouped_expression_4_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && expression(builder_, level_ + 1);
    result_ = result_ && grouped_expression_4_0_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [assign_op NLS expression]
  private static boolean grouped_expression_4_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "grouped_expression_4_0_3")) return false;
    grouped_expression_4_0_3_0(builder_, level_ + 1);
    return true;
  }

  // assign_op NLS expression
  private static boolean grouped_expression_4_0_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "grouped_expression_4_0_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = assign_op(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // hash_key (DOUBLE_ARROW | COLON) expression
  public static boolean hash_entry(PsiBuilder builder_, int level_) {
    ...
    result_ = hash_key(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // macro_trivia hash_entry (hash_entry_separator hash_entry)* [macro_trivia COMMA] macro_trivia
  ...
  // (hash_entry_separator hash_entry)*
  ...
  private static boolean hash_entry_list_0_2_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = hash_entry_separator(builder_, level_ + 1);
    result_ = result_ && hash_entry(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // macro_trivia COMMA macro_trivia
  //                                | NEWLINE* macro_control (NEWLINE | macro_control)* [COMMA] (NEWLINE | macro_control)*
  static boolean hash_entry_separator(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = hash_entry_separator_0(builder_, level_ + 1);
    if (!result_) result_ = hash_entry_separator_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // macro_trivia COMMA macro_trivia
  private static boolean hash_entry_separator_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_trivia(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
  ...
  // NEWLINE* macro_control (NEWLINE | macro_control)* [COMMA] (NEWLINE | macro_control)*
  private static boolean hash_entry_separator_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = hash_entry_separator_1_0(builder_, level_ + 1);
    result_ = result_ && macro_control(builder_, level_ + 1);
    result_ = result_ && hash_entry_separator_1_2(builder_, level_ + 1);
    result_ = result_ && hash_entry_separator_1_3(builder_, level_ + 1);
    result_ = result_ && hash_entry_separator_1_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // NEWLINE*
  private static boolean hash_entry_separator_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_0")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!consumeToken(builder_, NEWLINE)) break;
      if (!empty_element_parsed_guard_(builder_, "hash_entry_separator_1_0", pos_)) break;
    }
    return true;
  }

  // (NEWLINE | macro_control)*
  private static boolean hash_entry_separator_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!hash_entry_separator_1_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "hash_entry_separator_1_2", pos_)) break;
    }
    return true;
  }

  // NEWLINE | macro_control
  private static boolean hash_entry_separator_1_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_2_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, NEWLINE);
    if (!result_) result_ = macro_control(builder_, level_ + 1);
    return result_;
  ...
  // [COMMA]
  private static boolean hash_entry_separator_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_3")) return false;
    consumeToken(builder_, COMMA);
    return true;
  }

  // (NEWLINE | macro_control)*
  private static boolean hash_entry_separator_1_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_4")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!hash_entry_separator_1_4_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "hash_entry_separator_1_4", pos_)) break;
    }
    return true;
  }

  // NEWLINE | macro_control
  private static boolean hash_entry_separator_1_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_entry_separator_1_4_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, NEWLINE);
    if (!result_) result_ = macro_control(builder_, level_ + 1);
    return result_;
  ...
  /* ********************************************************** */
  // spliced_hash_key | expression
  static boolean hash_key(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hash_key")) return false;
    boolean result_;
    result_ = spliced_hash_key(builder_, level_ + 1);
    if (!result_) result_ = expression(builder_, level_ + 1);
    return result_;
  }
  ...
  // (HEREDOC_CONTENT | STRING_ESCAPE | interpolation_expression)*
  ...
  private static boolean implicit_object_call_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && implicit_object_call_0_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // IDENTIFIER | keyword_as_method | INSTANCE_VAR | CLASS_VAR | RESPONDS_TO | IS_A | NIL_QUESTION | AS | AS_QUESTION | macro_interpolation | operator_method_name
  ...
  private static boolean implicit_object_call_0_2(PsiBuilder builder_, int level_) {
    ...
    implicit_object_call_0_2_0(builder_, level_ + 1);
    return true;
  }

  // &<<isTokenTightAfterPreviousToken>> QUESTION
  private static boolean implicit_object_call_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = implicit_object_call_0_2_0_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, QUESTION);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean implicit_object_call_0_2_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_2_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [call_args [block] | !DOT !LBRACKET !LBRACE !<<isHeredocBodyOpener>> bare_argument_list [block] | !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list | block]
  private static boolean implicit_object_call_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3")) return false;
    implicit_object_call_0_3_0(builder_, level_ + 1);
    return true;
  }

  // call_args [block] | !DOT !LBRACKET !LBRACE !<<isHeredocBodyOpener>> bare_argument_list [block] | !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list | block
  private static boolean implicit_object_call_0_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = implicit_object_call_0_3_0_0(builder_, level_ + 1);
    if (!result_) result_ = implicit_object_call_0_3_0_1(builder_, level_ + 1);
    if (!result_) result_ = implicit_object_call_0_3_0_2(builder_, level_ + 1);
  ...
  // call_args [block]
  private static boolean implicit_object_call_0_3_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = call_args(builder_, level_ + 1);
    result_ = result_ && implicit_object_call_0_3_0_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [block]
  private static boolean implicit_object_call_0_3_0_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_0_1")) return false;
    block(builder_, level_ + 1);
    return true;
  }

  // !DOT !LBRACKET !LBRACE !<<isHeredocBodyOpener>> bare_argument_list [block]
  private static boolean implicit_object_call_0_3_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = implicit_object_call_0_3_0_1_0(builder_, level_ + 1);
    result_ = result_ && implicit_object_call_0_3_0_1_1(builder_, level_ + 1);
    result_ = result_ && implicit_object_call_0_3_0_1_2(builder_, level_ + 1);
    result_ = result_ && implicit_object_call_0_3_0_1_3(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    result_ = result_ && implicit_object_call_0_3_0_1_5(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !DOT
  private static boolean implicit_object_call_0_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACKET
  private static boolean implicit_object_call_0_3_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean implicit_object_call_0_3_0_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean implicit_object_call_0_3_0_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [block]
  private static boolean implicit_object_call_0_3_0_1_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_1_5")) return false;
    block(builder_, level_ + 1);
    return true;
  }

  // !<<isTokenTightAfterPreviousToken>> array_literal COMMA bare_argument_list
  private static boolean implicit_object_call_0_3_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = implicit_object_call_0_3_0_2_0(builder_, level_ + 1);
    result_ = result_ && array_literal(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean implicit_object_call_0_3_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_0_3_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean implicit_object_call_1_4(PsiBuilder builder_, int level_) {
    ...
    implicit_object_call_1_4_0(builder_, level_ + 1);
    return true;
  }

  // &<<isTokenTightAfterPreviousToken>> QUESTION
  private static boolean implicit_object_call_1_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_1_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = implicit_object_call_1_4_0_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, QUESTION);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean implicit_object_call_1_4_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "implicit_object_call_1_4_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean indexed_assignment_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = indexed_assignment_1_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!indexed_assignment_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "indexed_assignment_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  public static boolean instance_var_access(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = instance_var_access_1(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // AT macro_interpolation [IDENTIFIER]
  private static boolean instance_var_access_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "instance_var_access_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, AT);
    result_ = result_ && macro_interpolation(builder_, level_ + 1);
    result_ = result_ && instance_var_access_1_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [IDENTIFIER]
  private static boolean instance_var_access_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "instance_var_access_1_2")) return false;
    consumeToken(builder_, IDENTIFIER);
    return true;
  }

  /* ********************************************************** */
  // (&<<isHeredocBodyOpener>> heredoc_literal)+
  public static boolean interleaved_heredoc_bodies(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interleaved_heredoc_bodies")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, HEREDOC_BODIES, "<interleaved heredoc bodies>");
    result_ = interleaved_heredoc_bodies_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!interleaved_heredoc_bodies_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "interleaved_heredoc_bodies", pos_)) break;
    }
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  // &<<isHeredocBodyOpener>> heredoc_literal
  private static boolean interleaved_heredoc_bodies_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interleaved_heredoc_bodies_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = interleaved_heredoc_bodies_0_0(builder_, level_ + 1);
    result_ = result_ && heredoc_literal(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // &<<isHeredocBodyOpener>>
  private static boolean interleaved_heredoc_bodies_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interleaved_heredoc_bodies_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  /* ********************************************************** */
  // STRING_INTERPOLATION_BEGIN expression [postfix_modifier] STRING_INTERPOLATION_END
  static boolean interpolation_expression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interpolation_expression")) return false;
    if (!nextTokenIs(builder_, STRING_INTERPOLATION_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, STRING_INTERPOLATION_BEGIN);
    result_ = result_ && expression(builder_, level_ + 1);
    result_ = result_ && interpolation_expression_2(builder_, level_ + 1);
  ...
  // [postfix_modifier]
  private static boolean interpolation_expression_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interpolation_expression_2")) return false;
    postfix_modifier(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // OF | UNION | UNINITIALIZED | FORALL | PREVIOUS_DEF | OUT
  ...
  public static boolean loose_grouped_postfix_argument(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument")) return false;
    if (!nextTokenIs(builder_, LPAREN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = grouped_expression(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, BARE_ARGUMENT, result_);
    return result_;
  }

  // bare_postfix_op+
  private static boolean loose_grouped_postfix_argument_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_postfix_op(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!bare_postfix_op(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "loose_grouped_postfix_argument_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // loose_grouped_postfix_argument (macro_argument_trivia COMMA macro_argument_trivia bare_argument)+ [COMMA macro_argument_trivia]
  public static boolean loose_grouped_postfix_argument_list(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_list")) return false;
    if (!nextTokenIs(builder_, LPAREN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = loose_grouped_postfix_argument(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_list_1(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_list_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, BARE_ARGUMENT_LIST, result_);
    return result_;
  }

  // (macro_argument_trivia COMMA macro_argument_trivia bare_argument)+
  private static boolean loose_grouped_postfix_argument_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_list_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = loose_grouped_postfix_argument_list_1_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!loose_grouped_postfix_argument_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "loose_grouped_postfix_argument_list_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // macro_argument_trivia COMMA macro_argument_trivia bare_argument
  private static boolean loose_grouped_postfix_argument_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_argument_trivia(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
  ...
  // [COMMA macro_argument_trivia]
  private static boolean loose_grouped_postfix_argument_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_list_2")) return false;
    loose_grouped_postfix_argument_list_2_0(builder_, level_ + 1);
    return true;
  }

  // COMMA macro_argument_trivia
  private static boolean loose_grouped_postfix_argument_list_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loose_grouped_postfix_argument_list_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && macro_argument_trivia(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // macro_branch_tag NLS method_definition_header
  public static boolean macro_branch_method_header(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_branch_method_header")) return false;
    if (!nextTokenIs(builder_, MACRO_CONTROL_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_branch_tag(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && method_definition_header(builder_, level_ + 1);
    exit_section_(builder_, marker_, MACRO_BRANCH_METHOD_HEADER, result_);
    return result_;
  }

  /* ********************************************************** */
  // MACRO_CONTROL_BEGIN (ELSE | ELSIF) macro_control_token* MACRO_CONTROL_END
  static boolean macro_branch_tag(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_branch_tag")) return false;
    if (!nextTokenIs(builder_, MACRO_CONTROL_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, MACRO_CONTROL_BEGIN);
    result_ = result_ && macro_branch_tag_1(builder_, level_ + 1);
    result_ = result_ && macro_branch_tag_2(builder_, level_ + 1);
  ...
  // ELSE | ELSIF
  private static boolean macro_branch_tag_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_branch_tag_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, ELSE);
    if (!result_) result_ = consumeToken(builder_, ELSIF);
    return result_;
  ...
  // macro_control_token*
  private static boolean macro_branch_tag_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_branch_tag_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_control_token(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_branch_tag_2", pos_)) break;
    }
    return true;
  }

  /* ********************************************************** */
  // &(method_definition_header NLS macro_branch_method_header) DEF method_name [LPAREN NLS parameter_list NLS RPAREN] [COLON type_reference] [FORALL CONSTANT (COMMA CONSTANT)*] NLS macro_branch_method_header+ NLS macro_end_tag method_body END
  public static boolean macro_conditional_method_definition(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition")) return false;
    if (!nextTokenIs(builder_, DEF)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, METHOD_DEFINITION, null);
    result_ = macro_conditional_method_definition_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, DEF);
    result_ = result_ && method_name(builder_, level_ + 1);
    pinned_ = result_; // pin = 3
    result_ = result_ && report_error_(builder_, macro_conditional_method_definition_3(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, macro_conditional_method_definition_4(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, macro_conditional_method_definition_5(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, NLS(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, macro_conditional_method_definition_7(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, NLS(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, macro_end_tag(builder_, level_ + 1)) && result_;
  ...
  // &(method_definition_header NLS macro_branch_method_header)
  private static boolean macro_conditional_method_definition_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = macro_conditional_method_definition_0_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // method_definition_header NLS macro_branch_method_header
  private static boolean macro_conditional_method_definition_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_definition_header(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && macro_branch_method_header(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [LPAREN NLS parameter_list NLS RPAREN]
  private static boolean macro_conditional_method_definition_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_3")) return false;
    macro_conditional_method_definition_3_0(builder_, level_ + 1);
    return true;
  }

  // LPAREN NLS parameter_list NLS RPAREN
  private static boolean macro_conditional_method_definition_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && NLS(builder_, level_ + 1);
  ...
  // [COLON type_reference]
  private static boolean macro_conditional_method_definition_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_4")) return false;
    macro_conditional_method_definition_4_0(builder_, level_ + 1);
    return true;
  }

  // COLON type_reference
  private static boolean macro_conditional_method_definition_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  private static boolean macro_conditional_method_definition_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_5")) return false;
    macro_conditional_method_definition_5_0(builder_, level_ + 1);
    return true;
  }

  // FORALL CONSTANT (COMMA CONSTANT)*
  private static boolean macro_conditional_method_definition_5_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_5_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, FORALL, CONSTANT);
    result_ = result_ && macro_conditional_method_definition_5_0_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (COMMA CONSTANT)*
  private static boolean macro_conditional_method_definition_5_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_5_0_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_conditional_method_definition_5_0_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_conditional_method_definition_5_0_2", pos_)) break;
    }
    return true;
  }

  // COMMA CONSTANT
  private static boolean macro_conditional_method_definition_5_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_5_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // macro_branch_method_header+
  private static boolean macro_conditional_method_definition_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_conditional_method_definition_7")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_branch_method_header(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!macro_branch_method_header(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_conditional_method_definition_7", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // macro_if_envelope | macro_open_control | macro_control_escaped | macro_interpolation | macro_interpolation_escaped
  static boolean macro_content_expression(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = macro_if_envelope(builder_, level_ + 1);
    if (!result_) result_ = macro_open_control(builder_, level_ + 1);
    if (!result_) result_ = macro_control_escaped(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation_escaped(builder_, level_ + 1);
    return result_;
  ...
  /* ********************************************************** */
  // MACRO_CONTROL_BEGIN END MACRO_CONTROL_END
  static boolean macro_end_tag(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_end_tag")) return false;
    if (!nextTokenIs(builder_, MACRO_CONTROL_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, MACRO_CONTROL_BEGIN, END, MACRO_CONTROL_END);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  /* ********************************************************** */
  // &<<isTokenTightAfterPreviousToken>> (IDENTIFIER | CONSTANT | macro_interpolation)
  static boolean macro_fragment_suffix(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_fragment_suffix")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_fragment_suffix_0(builder_, level_ + 1);
    result_ = result_ && macro_fragment_suffix_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // &<<isTokenTightAfterPreviousToken>>
  private static boolean macro_fragment_suffix_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_fragment_suffix_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean macro_fragment_suffix_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_fragment_suffix_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
  ...
  public static boolean macro_if_envelope(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, marker_, MACRO_IF_ENVELOPE, result_);
    return result_;
  }
  ...
  private static boolean macro_if_envelope_3(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_if_envelope_3_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!macro_if_envelope_3_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_if_envelope_3", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // MACRO_CONTROL_BEGIN (IF | UNLESS) macro_control_token* MACRO_CONTROL_END
  static boolean macro_if_open(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_if_open")) return false;
    if (!nextTokenIs(builder_, MACRO_CONTROL_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, MACRO_CONTROL_BEGIN);
    result_ = result_ && macro_if_open_1(builder_, level_ + 1);
    result_ = result_ && macro_if_open_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, MACRO_CONTROL_END);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // IF | UNLESS
  private static boolean macro_if_open_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_if_open_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IF);
    if (!result_) result_ = consumeToken(builder_, UNLESS);
    return result_;
  ...
  // macro_control_token*
  private static boolean macro_if_open_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_if_open_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_control_token(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_if_open_2", pos_)) break;
    }
    return true;
  }

  /* ********************************************************** */
  // MACRO_INTERPOLATION_BEGIN NLS expression [postfix_modifier] NLS MACRO_INTERPOLATION_END
  public static boolean macro_interpolation(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && expression(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_3(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
  ...
  // [postfix_modifier]
  private static boolean macro_interpolation_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_3")) return false;
    postfix_modifier(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // macro_interpolation macro_fragment_suffix* [call_args | !DOT !LBRACKET !LBRACE !binary_op_lookahead !<<isHeredocBodyOpener>> bare_argument_list] [block]
  static boolean macro_interpolation_call(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call")) return false;
    if (!nextTokenIs(builder_, MACRO_INTERPOLATION_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_interpolation(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_1(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_2(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // macro_fragment_suffix*
  private static boolean macro_interpolation_call_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_fragment_suffix(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_interpolation_call_1", pos_)) break;
    }
    return true;
  }

  // [call_args | !DOT !LBRACKET !LBRACE !binary_op_lookahead !<<isHeredocBodyOpener>> bare_argument_list]
  private static boolean macro_interpolation_call_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2")) return false;
    macro_interpolation_call_2_0(builder_, level_ + 1);
    return true;
  }

  // call_args | !DOT !LBRACKET !LBRACE !binary_op_lookahead !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean macro_interpolation_call_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = call_args(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation_call_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !DOT !LBRACKET !LBRACE !binary_op_lookahead !<<isHeredocBodyOpener>> bare_argument_list
  private static boolean macro_interpolation_call_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_interpolation_call_2_0_1_0(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_2_0_1_1(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_2_0_1_2(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_2_0_1_3(builder_, level_ + 1);
    result_ = result_ && macro_interpolation_call_2_0_1_4(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !DOT
  private static boolean macro_interpolation_call_2_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACKET
  private static boolean macro_interpolation_call_2_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean macro_interpolation_call_2_0_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !binary_op_lookahead
  private static boolean macro_interpolation_call_2_0_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean macro_interpolation_call_2_0_1_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_interpolation_call_2_0_1_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  public static boolean macro_open_control(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, MACRO_CONTROL_BEGIN);
    result_ = result_ && macro_open_control_1(builder_, level_ + 1);
    result_ = result_ && macro_open_control_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, MACRO_CONTROL_END);
    exit_section_(builder_, marker_, MACRO_CONTROL, result_);
    return result_;
  }
  ...
  // !(ELSE | ELSIF | END)
  private static boolean macro_open_control_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_open_control_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !macro_open_control_1_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // ELSE | ELSIF | END
  private static boolean macro_open_control_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_open_control_1_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, ELSE);
    if (!result_) result_ = consumeToken(builder_, ELSIF);
    if (!result_) result_ = consumeToken(builder_, END);
  ...
  // macro_control_token*
  private static boolean macro_open_control_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_open_control_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_control_token(builder_, level_ + 1)) break;
  ...
  static boolean macro_spliced_parameter_name(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_spliced_parameter_name")) return false;
    if (!nextTokenIs(builder_, IDENTIFIER)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, IDENTIFIER);
    result_ = result_ && macro_interpolation(builder_, level_ + 1);
    result_ = result_ && macro_spliced_parameter_name_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (IDENTIFIER | CONSTANT | macro_interpolation)*
  private static boolean macro_spliced_parameter_name_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_spliced_parameter_name_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_spliced_parameter_name_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "macro_spliced_parameter_name_2", pos_)) break;
    }
    return true;
  }

  // IDENTIFIER | CONSTANT | macro_interpolation
  private static boolean macro_spliced_parameter_name_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_spliced_parameter_name_2_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
  ...
  //                           // A loose parenthesized first bare argument may carry
  //                           // postfix access before later comma arguments:
  //                           // `write_extra_newlines (a || b).end_location, b.location`
  //                           // (compiler syntax/to_s.cr). This must precede call_args,
  //                           // which would commit `(a || b)` as the call's complete
  //                           // parenthesized argument list and strand the postfix/comma.
  //                            | [DOUBLE_COLON] call_callee !<<isTokenTightAfterPreviousToken>> loose_grouped_postfix_argument_list [block]
  //                            | [DOUBLE_COLON] call_callee !<<isTokenTightAfterPreviousToken>> call_args COMMA bare_argument_list [block]
  //                           | [DOUBLE_COLON] call_callee call_args [block]
  ...
  //                           | [DOUBLE_COLON] call_callee !DOT !LBRACE !<<isDotBareArgsBinaryOp>> !<<isTokenTightAfterPreviousToken>> !<<isHeredocBodyOpener>> bare_argument_list [block]
  //                            | [DOUBLE_COLON] bare_call_callee block
  //                            | bare_call_callee block
  ...
  public static boolean method_call_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = method_call_expression_6(builder_, level_ + 1);
    if (!result_) result_ = method_call_expression_7(builder_, level_ + 1);
    if (!result_) result_ = method_call_expression_8(builder_, level_ + 1);
    if (!result_) result_ = method_call_expression_9(builder_, level_ + 1);
    if (!result_) result_ = method_call_expression_10(builder_, level_ + 1);
    if (!result_) result_ = method_call_expression_11(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean method_call_expression_0_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isRecordDeclaration(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean method_call_expression_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && method_call_expression_1_2(builder_, level_ + 1);
    result_ = result_ && loose_grouped_postfix_argument_list(builder_, level_ + 1);
    result_ = result_ && method_call_expression_1_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [block]
  private static boolean method_call_expression_1_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_1_4")) return false;
    block(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean method_call_expression_2(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && method_call_expression_2_2(builder_, level_ + 1);
    result_ = result_ && call_args(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    result_ = result_ && method_call_expression_2_6(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean method_call_expression_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_2_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [block]
  private static boolean method_call_expression_2_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_2_6")) return false;
    block(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean method_call_expression_3(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && call_args(builder_, level_ + 1);
    result_ = result_ && method_call_expression_3_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [block]
  private static boolean method_call_expression_3_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_3_3")) return false;
    block(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean method_call_expression_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && method_call_expression_4_2(builder_, level_ + 1);
  ...
  // !DOT
  private static boolean method_call_expression_4_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_4_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACKET
  private static boolean method_call_expression_4_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_4_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean method_call_expression_4_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_4_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isDotBareArgsBinaryOp>>
  private static boolean method_call_expression_4_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_4_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isDotBareArgsBinaryOp(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean method_call_expression_5(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && method_call_expression_5_2(builder_, level_ + 1);
    result_ = result_ && array_literal(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    result_ = result_ && method_call_expression_5_6(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean method_call_expression_5_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_5_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [block]
  private static boolean method_call_expression_5_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_5_6")) return false;
    block(builder_, level_ + 1);
    return true;
  }

  // [DOUBLE_COLON] call_callee !DOT !LBRACE !<<isDotBareArgsBinaryOp>> !<<isTokenTightAfterPreviousToken>> !<<isHeredocBodyOpener>> bare_argument_list [block]
  private static boolean method_call_expression_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_call_expression_6_0(builder_, level_ + 1);
    result_ = result_ && call_callee(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_2(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_3(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_4(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_5(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_6(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    result_ = result_ && method_call_expression_6_8(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [DOUBLE_COLON]
  private static boolean method_call_expression_6_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_0")) return false;
    consumeToken(builder_, DOUBLE_COLON);
    return true;
  }

  // !DOT
  private static boolean method_call_expression_6_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean method_call_expression_6_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isDotBareArgsBinaryOp>>
  private static boolean method_call_expression_6_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isDotBareArgsBinaryOp(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isTokenTightAfterPreviousToken>>
  private static boolean method_call_expression_6_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !<<isHeredocBodyOpener>>
  private static boolean method_call_expression_6_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !isHeredocBodyOpener(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [block]
  private static boolean method_call_expression_6_8(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_6_8")) return false;
    block(builder_, level_ + 1);
    return true;
  }

  // [DOUBLE_COLON] bare_call_callee block
  private static boolean method_call_expression_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_7")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_call_expression_7_0(builder_, level_ + 1);
    result_ = result_ && bare_call_callee(builder_, level_ + 1);
  ...
  // [DOUBLE_COLON]
  private static boolean method_call_expression_7_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_7_0")) return false;
    consumeToken(builder_, DOUBLE_COLON);
    return true;
  }

  // bare_call_callee block
  private static boolean method_call_expression_8(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_8")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_call_callee(builder_, level_ + 1);
    result_ = result_ && block(builder_, level_ + 1);
  ...
  // (SUPER | PREVIOUS_DEF) block
  private static boolean method_call_expression_9(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_9")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_call_expression_9_0(builder_, level_ + 1);
    result_ = result_ && block(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // SUPER | PREVIOUS_DEF
  private static boolean method_call_expression_9_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_9_0")) return false;
    boolean result_;
  ...
  // (SUPER | PREVIOUS_DEF) call_args [block]
  private static boolean method_call_expression_10(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_10")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_call_expression_10_0(builder_, level_ + 1);
    result_ = result_ && call_args(builder_, level_ + 1);
    result_ = result_ && method_call_expression_10_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // SUPER | PREVIOUS_DEF
  private static boolean method_call_expression_10_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_10_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, SUPER);
    if (!result_) result_ = consumeToken(builder_, PREVIOUS_DEF);
    return result_;
  ...
  // [block]
  private static boolean method_call_expression_10_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_10_2")) return false;
    block(builder_, level_ + 1);
    return true;
  }

  // (SUPER | PREVIOUS_DEF) !DOT !LBRACKET !LBRACE !binary_op_lookahead bare_argument_list [block]
  private static boolean method_call_expression_11(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = method_call_expression_11_0(builder_, level_ + 1);
    result_ = result_ && method_call_expression_11_1(builder_, level_ + 1);
    result_ = result_ && method_call_expression_11_2(builder_, level_ + 1);
    result_ = result_ && method_call_expression_11_3(builder_, level_ + 1);
    result_ = result_ && method_call_expression_11_4(builder_, level_ + 1);
    result_ = result_ && bare_argument_list(builder_, level_ + 1);
    result_ = result_ && method_call_expression_11_6(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // SUPER | PREVIOUS_DEF
  private static boolean method_call_expression_11_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, SUPER);
    if (!result_) result_ = consumeToken(builder_, PREVIOUS_DEF);
    return result_;
  ...
  // !DOT
  private static boolean method_call_expression_11_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, DOT);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACKET
  private static boolean method_call_expression_11_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACKET);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !LBRACE
  private static boolean method_call_expression_11_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeToken(builder_, LBRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // !binary_op_lookahead
  private static boolean method_call_expression_11_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !binary_op_lookahead(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [block]
  private static boolean method_call_expression_11_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_call_expression_11_6")) return false;
    block(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // DEF method_name [LPAREN NLS parameter_list NLS RPAREN] [COLON type_reference] [FORALL CONSTANT (COMMA CONSTANT)*]
  static boolean method_definition_header(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header")) return false;
    if (!nextTokenIs(builder_, DEF)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, DEF);
    result_ = result_ && method_name(builder_, level_ + 1);
    result_ = result_ && method_definition_header_2(builder_, level_ + 1);
    result_ = result_ && method_definition_header_3(builder_, level_ + 1);
    result_ = result_ && method_definition_header_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [LPAREN NLS parameter_list NLS RPAREN]
  private static boolean method_definition_header_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_2")) return false;
    method_definition_header_2_0(builder_, level_ + 1);
    return true;
  }

  // LPAREN NLS parameter_list NLS RPAREN
  private static boolean method_definition_header_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && NLS(builder_, level_ + 1);
  ...
  // [COLON type_reference]
  private static boolean method_definition_header_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_3")) return false;
    method_definition_header_3_0(builder_, level_ + 1);
    return true;
  }

  // COLON type_reference
  private static boolean method_definition_header_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  // [FORALL CONSTANT (COMMA CONSTANT)*]
  private static boolean method_definition_header_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_4")) return false;
    method_definition_header_4_0(builder_, level_ + 1);
    return true;
  }

  // FORALL CONSTANT (COMMA CONSTANT)*
  private static boolean method_definition_header_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, FORALL, CONSTANT);
    result_ = result_ && method_definition_header_4_0_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (COMMA CONSTANT)*
  private static boolean method_definition_header_4_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_4_0_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!method_definition_header_4_0_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "method_definition_header_4_0_2", pos_)) break;
    }
    return true;
  }

  // COMMA CONSTANT
  private static boolean method_definition_header_4_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_definition_header_4_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, COMMA, CONSTANT);
    exit_section_(builder_, marker_, null, result_);
  ...
  // BACKTICK
  //               |  IDENTIFIER ASSIGN
  //               // Keyword setters (`def private=(value)` in types.cr): the
  //               // compiler accepts any keyword plus `=` as a setter name, while
  //               // operators stay invalid — hence keyword_identifier, not the
  //               // wider keyword_as_method. Setter forms precede plain names.
  //               |  keyword_identifier ASSIGN
  //               | SELF DOT IDENTIFIER ASSIGN
  //               | SELF DOT keyword_identifier ASSIGN
  ...
  static boolean method_name(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = parseTokens(builder_, 0, IDENTIFIER, ASSIGN);
    ...
    if (!result_) result_ = method_name_10(builder_, level_ + 1);
    if (!result_) result_ = method_name_11(builder_, level_ + 1);
    if (!result_) result_ = keyword_as_method(builder_, level_ + 1);
    if (!result_) result_ = operator_method_name(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean method_name_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && keyword_identifier(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ASSIGN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // IDENTIFIER ASSIGN | IDENTIFIER | keyword_as_method | operator_method_name
  ...
  private static boolean method_name_8(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && method_name_8_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [ASSIGN]
  private static boolean method_name_8_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_name_8_3")) return false;
    consumeToken(builder_, ASSIGN);
    return true;
  }
  ...
  // operator_method_name macro_interpolation (IDENTIFIER | CONSTANT | macro_interpolation)*
  private static boolean method_name_11(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_name_11")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = operator_method_name(builder_, level_ + 1);
    result_ = result_ && macro_interpolation(builder_, level_ + 1);
    result_ = result_ && method_name_11_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (IDENTIFIER | CONSTANT | macro_interpolation)*
  private static boolean method_name_11_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_name_11_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!method_name_11_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "method_name_11_2", pos_)) break;
    }
    return true;
  }

  // IDENTIFIER | CONSTANT | macro_interpolation
  private static boolean method_name_11_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_name_11_2_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // indexed_assignment_target (LBRACKET indexed_assignment_index RBRACKET)+
  static boolean multi_assign_indexed_target(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "multi_assign_indexed_target")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = indexed_assignment_target(builder_, level_ + 1);
    result_ = result_ && multi_assign_indexed_target_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (LBRACKET indexed_assignment_index RBRACKET)+
  private static boolean multi_assign_indexed_target_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "multi_assign_indexed_target_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = multi_assign_indexed_target_1_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!multi_assign_indexed_target_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "multi_assign_indexed_target_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // LBRACKET indexed_assignment_index RBRACKET
  private static boolean multi_assign_indexed_target_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "multi_assign_indexed_target_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LBRACKET);
    result_ = result_ && indexed_assignment_index(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // STAR (multi_assign_indexed_target | multi_assign_member_target | variable | UNDERSCORE)
  ...
  // multi_assign_indexed_target | multi_assign_member_target | variable | UNDERSCORE
  private static boolean multi_assign_target_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = multi_assign_indexed_target(builder_, level_ + 1);
    if (!result_) result_ = multi_assign_member_target(builder_, level_ + 1);
    if (!result_) result_ = variable(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, UNDERSCORE);
    return result_;
  ...
  /* ********************************************************** */
  // multi_assign_target COMMA NLS multi_assign_target_list ASSIGN NLS multi_assign_values [postfix_modifier] [heredoc_bodies]
  public static boolean multi_assignment(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, multi_assignment_7(builder_, level_ + 1)) && result_;
    result_ = pinned_ && multi_assignment_8(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // [heredoc_bodies]
  private static boolean multi_assignment_8(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "multi_assignment_8")) return false;
    heredoc_bodies(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // (IDENTIFIER | keyword_identifier | string_label | macro_interpolation) compact_colon NLS (control_value | expression)
  static boolean named_argument(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && compact_colon(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, NLS(builder_, level_ + 1));
  ...
  // IDENTIFIER | keyword_identifier | string_label | macro_interpolation
  private static boolean named_argument_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = keyword_identifier(builder_, level_ + 1);
    if (!result_) result_ = string_label(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
    return result_;
  }
  ...
  private static boolean named_argument_3(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = control_value(builder_, level_ + 1);
    if (!result_) result_ = expression(builder_, level_ + 1);
    return result_;
  }

  /* ********************************************************** */
  // (IDENTIFIER | keyword_identifier | string_label | macro_interpolation) compact_colon NLS
  //     (control_value | absolute_namespace_bare_expression [ASSIGN bare_expression] | bare_expression [ASSIGN bare_expression])
  ...
  private static boolean named_bare_argument_3(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = named_bare_argument_3_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // absolute_namespace_bare_expression [ASSIGN bare_expression]
  private static boolean named_bare_argument_3_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = absolute_namespace_bare_expression(builder_, level_ + 1);
  ...
  private static boolean named_bare_argument_3_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_bare_argument_3_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = bare_expression(builder_, level_ + 1);
    result_ = result_ && named_bare_argument_3_2_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [ASSIGN bare_expression]
  private static boolean named_bare_argument_3_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_bare_argument_3_2_1")) return false;
    named_bare_argument_3_2_1_0(builder_, level_ + 1);
    return true;
  }

  // ASSIGN bare_expression
  private static boolean named_bare_argument_3_2_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_bare_argument_3_2_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ASSIGN);
    result_ = result_ && bare_expression(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (IDENTIFIER | keyword_identifier) spaced_colon NLS type_reference [named_type_default]
  static boolean named_type_argument(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_argument")) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_);
    result_ = named_type_argument_0(builder_, level_ + 1);
    result_ = result_ && spaced_colon(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, NLS(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, type_reference(builder_, level_ + 1)) && result_;
    result_ = pinned_ && named_type_argument_4(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  // IDENTIFIER | keyword_identifier
  private static boolean named_type_argument_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_argument_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = keyword_identifier(builder_, level_ + 1);
    return result_;
  ...
  // [named_type_default]
  private static boolean named_type_argument_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_argument_4")) return false;
    named_type_default(builder_, level_ + 1);
    return true;
  }
  ...
  // [named_type_default]
  private static boolean named_type_bare_argument_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_bare_argument_3")) return false;
    named_type_default(builder_, level_ + 1);
    return true;
  }
  ...
  static boolean named_type_default(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_default")) return false;
    if (!nextTokenIs(builder_, ASSIGN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ASSIGN);
    result_ = result_ && named_type_default_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // assignment | expression
  private static boolean named_type_default_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "named_type_default_1")) return false;
    boolean result_;
    result_ = assignment(builder_, level_ + 1);
    if (!result_) result_ = expression(builder_, level_ + 1);
    return result_;
  ...
  /* ********************************************************** */
  // DOUBLE_COLON (CONSTANT | macro_interpolation) macro_fragment_suffix*
  public static boolean namespace_access(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && namespace_access_2(builder_, level_ + 1);
  ...
  // macro_fragment_suffix*
  private static boolean namespace_access_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "namespace_access_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!macro_fragment_suffix(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "namespace_access_2", pos_)) break;
    }
    return true;
  }

  /* ********************************************************** */
  // variable assign_op NLS (nested_assignment | nested_indexed_assignment | expression)
  ...
  // nested_assignment | nested_indexed_assignment | expression
  ...
  static boolean nested_call_lookahead(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = binary_op_lookahead(builder_, level_ + 1);
    if (!result_) result_ = nested_call_lookahead_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // DOTDOT | DOTDOTDOT
  private static boolean nested_call_lookahead_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "nested_call_lookahead_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, DOTDOT);
    if (!result_) result_ = consumeToken(builder_, DOTDOTDOT);
    return result_;
  ...
  public static boolean nested_indexed_assignment(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && assign_op(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && nested_indexed_assignment_4(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean nested_indexed_assignment_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = nested_indexed_assignment_1_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!nested_indexed_assignment_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "nested_indexed_assignment_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  //             | param_prefix* macro_spliced_parameter_name [COLON type_reference] [ASSIGN expression]
  ...
  //             // A double-splat parameter may carry a double-splat restriction
  //             // (`def self.new(**options : **T)` in named_tuple.cr): the compiler
  //             // pairs the restriction splat strictly with the parameter splat
  //             // (parser.cr parse_parameter), so `x : **T` stays invalid. This
  //             // longer alternative precedes the plain splat form (PEG).
  //             | param_prefix* DOUBLE_STAR (IDENTIFIER | instance_var_access | class_var_access | keyword_parameter_name) [COLON [DOUBLE_STAR] type_reference] [ASSIGN expression]
  //             | param_prefix* [STAR | AMPERSAND] (IDENTIFIER | instance_var_access | class_var_access | keyword_parameter_name) [COLON type_reference] [ASSIGN expression]
  ...
  // IDENTIFIER | instance_var_access | class_var_access
  ...
  private static boolean parameter_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && macro_spliced_parameter_name(builder_, level_ + 1);
  ...
  private static boolean parameter_2(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && keyword_parameter_name(builder_, level_ + 1);
    result_ = result_ && parameter_2_2(builder_, level_ + 1);
  ...
  // [COLON type_reference]
  private static boolean parameter_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_2_2")) return false;
    parameter_2_2_0(builder_, level_ + 1);
    return true;
  }

  // COLON type_reference
  private static boolean parameter_2_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_2_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  private static boolean parameter_3(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeTokens(builder_, 0, AMPERSAND, IDENTIFIER, COLON);
    result_ = result_ && type_union(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
    result_ = result_ && type_union(builder_, level_ + 1);
    result_ = result_ && parameter_3_7(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ARROW);
    result_ = result_ && parameter_3_9(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // (COMMA type_union)*
  private static boolean parameter_3_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_3_7")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!parameter_3_7_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "parameter_3_7", pos_)) break;
    }
    return true;
  }

  // COMMA type_union
  private static boolean parameter_3_7_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_3_7_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && type_union(builder_, level_ + 1);
  ...
  // [type_reference]
  private static boolean parameter_3_9(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_3_9")) return false;
  ...
  private static boolean parameter_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, DOUBLE_STAR);
  ...
  // IDENTIFIER | instance_var_access | class_var_access | keyword_parameter_name
  private static boolean parameter_4_2(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = instance_var_access(builder_, level_ + 1);
    if (!result_) result_ = class_var_access(builder_, level_ + 1);
    if (!result_) result_ = keyword_parameter_name(builder_, level_ + 1);
    return result_;
  }

  // [COLON [DOUBLE_STAR] type_reference]
  ...
  private static boolean parameter_4_3_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON);
    result_ = result_ && parameter_4_3_0_1(builder_, level_ + 1);
    result_ = result_ && type_reference(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [DOUBLE_STAR]
  private static boolean parameter_4_3_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_4_3_0_1")) return false;
  ...
  private static boolean parameter_9(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && parameter_9_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean parameter_9_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_9_3")) return false;
    parameter_9_3_0(builder_, level_ + 1);
    return true;
  }

  // &<<isTokenTightAfterPreviousToken>> STAR
  private static boolean parameter_9_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_9_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = parameter_9_3_0_0(builder_, level_ + 1);
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean parameter_9_3_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parameter_9_3_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  /* ********************************************************** */
  // STRING_LITERAL | STRING_ESCAPE | interpolation_expression | SYMBOL_LITERAL | REGEX_LITERAL | COMMAND_LITERAL | NEWLINE
  ...
  /* ********************************************************** */
  // (IF | UNLESS | RESCUE) postfix_condition_with_assignment [postfix_modifier]
  public static boolean postfix_modifier(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, POSTFIX_MODIFIER, "<postfix modifier>");
  ...
  /* ********************************************************** */
  // ARROW LPAREN proc_parameter_trivia parameter_list proc_parameter_trivia RPAREN LBRACE statement_list RBRACE
  //                | ARROW LPAREN proc_parameter_trivia parameter_list proc_parameter_trivia RPAREN DO [statement_list] END
  ...
  public static boolean proc_literal(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = proc_literal_5(builder_, level_ + 1);
  ...
  private static boolean proc_literal_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && proc_parameter_trivia(builder_, level_ + 1);
    result_ = result_ && parameter_list(builder_, level_ + 1);
    result_ = result_ && proc_parameter_trivia(builder_, level_ + 1);
  ...
  private static boolean proc_literal_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && proc_literal_1_7(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, END);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // [statement_list]
  private static boolean proc_literal_1_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_1_7")) return false;
    statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean proc_literal_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && proc_literal_4_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean proc_literal_4_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_4_4")) return false;
    proc_literal_4_4_0(builder_, level_ + 1);
    return true;
  }

  // LPAREN type_reference (COMMA type_reference)* RPAREN
  private static boolean proc_literal_4_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_4_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && proc_literal_4_4_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // (COMMA type_reference)*
  private static boolean proc_literal_4_4_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_4_4_0_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!proc_literal_4_4_0_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "proc_literal_4_4_0_2", pos_)) break;
    }
    return true;
  }

  // COMMA type_reference
  private static boolean proc_literal_4_4_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_4_4_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  // ARROW (IDENTIFIER | CONSTANT) [DOT (IDENTIFIER | CONSTANT)] [LPAREN type_reference (COMMA type_reference)* RPAREN]
  private static boolean proc_literal_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ARROW);
    result_ = result_ && proc_literal_5_1(builder_, level_ + 1);
    result_ = result_ && proc_literal_5_2(builder_, level_ + 1);
    result_ = result_ && proc_literal_5_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // IDENTIFIER | CONSTANT
  private static boolean proc_literal_5_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    return result_;
  ...
  private static boolean proc_literal_5_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_2")) return false;
    proc_literal_5_2_0(builder_, level_ + 1);
    return true;
  }

  // DOT (IDENTIFIER | CONSTANT)
  private static boolean proc_literal_5_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, DOT);
    result_ = result_ && proc_literal_5_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // IDENTIFIER | CONSTANT
  private static boolean proc_literal_5_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_2_0_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    return result_;
  ...
  // [LPAREN type_reference (COMMA type_reference)* RPAREN]
  private static boolean proc_literal_5_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_3")) return false;
    proc_literal_5_3_0(builder_, level_ + 1);
    return true;
  }

  // LPAREN type_reference (COMMA type_reference)* RPAREN
  private static boolean proc_literal_5_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && proc_literal_5_3_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // (COMMA type_reference)*
  private static boolean proc_literal_5_3_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_3_0_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!proc_literal_5_3_0_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "proc_literal_5_3_0_2", pos_)) break;
    }
    return true;
  }

  // COMMA type_reference
  private static boolean proc_literal_5_3_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_literal_5_3_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (NEWLINE | macro_control)*
  static boolean proc_parameter_trivia(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_parameter_trivia")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!proc_parameter_trivia_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "proc_parameter_trivia", pos_)) break;
    }
    return true;
  }

  // NEWLINE | macro_control
  private static boolean proc_parameter_trivia_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "proc_parameter_trivia_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, NEWLINE);
    if (!result_) result_ = macro_control(builder_, level_ + 1);
    return result_;
  ...
  static boolean range_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = range_expression_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean range_expression_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && range_expression_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [(DOTDOT | DOTDOTDOT) [or_bitwise_expression]]
  private static boolean range_expression_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "range_expression_1_1")) return false;
    range_expression_1_1_0(builder_, level_ + 1);
    return true;
  }

  // (DOTDOT | DOTDOTDOT) [or_bitwise_expression]
  private static boolean range_expression_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "range_expression_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = range_expression_1_1_0_0(builder_, level_ + 1);
    result_ = result_ && range_expression_1_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // DOTDOT | DOTDOTDOT
  private static boolean range_expression_1_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "range_expression_1_1_0_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, DOTDOT);
    if (!result_) result_ = consumeToken(builder_, DOTDOTDOT);
    return result_;
  ...
  // [or_bitwise_expression]
  private static boolean range_expression_1_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "range_expression_1_1_0_1")) return false;
    or_bitwise_expression(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // REGEX_BEGIN (REGEX_LITERAL | STRING_ESCAPE | interpolation_expression)* REGEX_END
  ...
  // (REGEX_LITERAL | STRING_ESCAPE | interpolation_expression)*
  ...
  /* ********************************************************** */
  // &<<isTokenTightAfterPreviousToken>> macro_control [PIPE type_reference] macro_control
  static boolean rescue_macro_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rescue_macro_tail")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = rescue_macro_tail_0(builder_, level_ + 1);
    result_ = result_ && macro_control(builder_, level_ + 1);
    result_ = result_ && rescue_macro_tail_2(builder_, level_ + 1);
    result_ = result_ && macro_control(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean rescue_macro_tail_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rescue_macro_tail_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [PIPE type_reference]
  private static boolean rescue_macro_tail_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rescue_macro_tail_2")) return false;
    rescue_macro_tail_2_0(builder_, level_ + 1);
    return true;
  }

  // PIPE type_reference
  private static boolean rescue_macro_tail_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rescue_macro_tail_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, PIPE);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  private static boolean rescue_spec_2_1(PsiBuilder builder_, int level_) {
    ...
    rescue_macro_tail(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // &<<colonHasLeadingDeclarationWhitespace>> COLON
  static boolean spaced_colon(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spaced_colon")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = spaced_colon_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COLON);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<colonHasLeadingDeclarationWhitespace>>
  private static boolean spaced_colon_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spaced_colon_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = colonHasLeadingDeclarationWhitespace(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  /* ********************************************************** */
  // (IDENTIFIER | CONSTANT) macro_interpolation (IDENTIFIER | CONSTANT | macro_interpolation)*
  public static boolean spliced_hash_key(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spliced_hash_key")) return false;
    if (!nextTokenIs(builder_, "<spliced hash key>", CONSTANT, IDENTIFIER)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, EXPRESSION, "<spliced hash key>");
    result_ = spliced_hash_key_0(builder_, level_ + 1);
    result_ = result_ && macro_interpolation(builder_, level_ + 1);
    result_ = result_ && spliced_hash_key_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // IDENTIFIER | CONSTANT
  private static boolean spliced_hash_key_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spliced_hash_key_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    return result_;
  ...
  // (IDENTIFIER | CONSTANT | macro_interpolation)*
  private static boolean spliced_hash_key_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spliced_hash_key_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!spliced_hash_key_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "spliced_hash_key_2", pos_)) break;
    }
    return true;
  }

  // IDENTIFIER | CONSTANT | macro_interpolation
  private static boolean spliced_hash_key_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spliced_hash_key_2_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, IDENTIFIER);
    if (!result_) result_ = consumeToken(builder_, CONSTANT);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
  ...
  static boolean statement_body(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = property_declaration(builder_, level_ + 1);
    if (!result_) result_ = indexed_assignment(builder_, level_ + 1);
    if (!result_) result_ = assignment(builder_, level_ + 1);
    if (!result_) result_ = constant_assignment(builder_, level_ + 1);
    if (!result_) result_ = macro_control(builder_, level_ + 1);
    if (!result_) result_ = macro_control_escaped(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (STRING_LITERAL | STRING_ESCAPE | macro_interpolation)+
  static boolean string_label(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "string_label")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = string_label_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!string_label_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "string_label", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // STRING_LITERAL | STRING_ESCAPE | macro_interpolation
  private static boolean string_label_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "string_label_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, STRING_LITERAL);
    if (!result_) result_ = consumeToken(builder_, STRING_ESCAPE);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // SYMBOL_COLON (STRING_LITERAL | STRING_ESCAPE | interpolation_expression)+
  ...
  public static boolean symbol_string_expression(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<symbol string expression>", COLON, SYMBOL_COLON)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, SYMBOL_STRING_EXPRESSION, "<symbol string expression>");
    result_ = symbol_string_expression_0(builder_, level_ + 1);
    if (!result_) result_ = symbol_string_expression_1(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // SYMBOL_COLON (STRING_LITERAL | STRING_ESCAPE | interpolation_expression)+
  private static boolean symbol_string_expression_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "symbol_string_expression_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, SYMBOL_COLON);
    result_ = result_ && symbol_string_expression_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (STRING_LITERAL | STRING_ESCAPE | interpolation_expression)+
  private static boolean symbol_string_expression_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "symbol_string_expression_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = symbol_string_expression_0_1_0(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!symbol_string_expression_0_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "symbol_string_expression_0_1", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // STRING_LITERAL | STRING_ESCAPE | interpolation_expression
  private static boolean symbol_string_expression_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "symbol_string_expression_0_1_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, STRING_LITERAL);
    if (!result_) result_ = consumeToken(builder_, STRING_ESCAPE);
    if (!result_) result_ = interpolation_expression(builder_, level_ + 1);
  ...
  private static boolean symbol_string_expression_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON);
    result_ = result_ && symbol_string_expression_1_1(builder_, level_ + 1);
    result_ = result_ && macro_interpolation(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isTokenTightAfterPreviousToken>>
  private static boolean symbol_string_expression_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "symbol_string_expression_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isTokenTightAfterPreviousToken(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // [heredoc_bodies]
  private static boolean tuple_literal_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tuple_literal_3")) return false;
    heredoc_bodies(builder_, level_ + 1);
    return true;
  }
  ...
  //                        | IDENTIFIER
  static boolean type_atom(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = type_atom_0(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, SELF);
    if (!result_) result_ = type_atom_3(builder_, level_ + 1);
    if (!result_) result_ = type_atom_4(builder_, level_ + 1);
    if (!result_) result_ = type_atom_5(builder_, level_ + 1);
    if (!result_) result_ = type_atom_6(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, IDENTIFIER);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // type_path [type_arguments]
  private static boolean type_atom_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = type_path(builder_, level_ + 1);
    result_ = result_ && type_atom_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [type_arguments]
  private static boolean type_atom_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_0_1")) return false;
  ...
  // LPAREN type_reference (COMMA type_reference)* RPAREN
  private static boolean type_atom_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && type_atom_4_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // (COMMA type_reference)*
  private static boolean type_atom_4_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_4_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_atom_4_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_atom_4_2", pos_)) break;
    }
    return true;
  }

  // COMMA type_reference
  private static boolean type_atom_4_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_4_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && type_reference(builder_, level_ + 1);
  ...
  // LBRACE NLS IDENTIFIER COLON type_reference (NLS COMMA NLS IDENTIFIER COLON type_reference)* NLS RBRACE
  private static boolean type_atom_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LBRACE);
    result_ = result_ && NLS(builder_, level_ + 1);
    ...
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && type_atom_5_5(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean type_atom_5_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_5_5")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_atom_5_5_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_atom_5_5", pos_)) break;
    }
    return true;
  }

  // NLS COMMA NLS IDENTIFIER COLON type_reference
  private static boolean type_atom_5_5_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_5_5_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = NLS(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
  ...
  // LBRACE NLS type_reference (NLS COMMA NLS type_reference)* NLS RBRACE
  private static boolean type_atom_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LBRACE);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && type_reference(builder_, level_ + 1);
    result_ = result_ && type_atom_6_3(builder_, level_ + 1);
    result_ = result_ && NLS(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean type_atom_6_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_6_3")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_atom_6_3_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_atom_6_3", pos_)) break;
    }
    return true;
  }

  // NLS COMMA NLS type_reference
  private static boolean type_atom_6_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_atom_6_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = NLS(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, COMMA);
  ...
  /* ********************************************************** */
  // [DOUBLE_COLON] type_path_piece (DOUBLE_COLON type_path_piece)*
  public static boolean type_path(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && type_path_piece(builder_, level_ + 1);
  ...
  // CONSTANT macro_interpolation?
  //                           | macro_interpolation
  static boolean type_path_piece(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_path_piece")) return false;
    if (!nextTokenIs(builder_, "", CONSTANT, MACRO_INTERPOLATION_BEGIN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = type_path_piece_0(builder_, level_ + 1);
    if (!result_) result_ = macro_interpolation(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // CONSTANT macro_interpolation?
  private static boolean type_path_piece_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_path_piece_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, CONSTANT);
    result_ = result_ && type_path_piece_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // macro_interpolation?
  private static boolean type_path_piece_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_path_piece_0_1")) return false;
    macro_interpolation(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // type_union (COMMA NLS type_union)* ARROW [type_union]
  ...
  public static boolean type_reference(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = type_reference_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean type_reference_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, ARROW);
    result_ = result_ && type_reference_0_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean type_reference_0_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      int pos_ = current_position_(builder_);
      if (!type_reference_0_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "type_reference_0_1", pos_)) break;
    }
    return true;
  }
  ...
  // [type_union]
  private static boolean type_reference_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_reference_0_3")) return false;
    type_union(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean type_reference_1_1(PsiBuilder builder_, int level_) {
    ...
    type_reference_1_1_0(builder_, level_ + 1);
    return true;
  }

  // ARROW [type_union]
  private static boolean type_reference_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_reference_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ARROW);
    result_ = result_ && type_reference_1_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [type_union]
  private static boolean type_reference_1_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_reference_1_1_0_1")) return false;
    type_union(builder_, level_ + 1);
    return true;
  }

  // ARROW [type_union]
  private static boolean type_reference_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_reference_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ARROW);
    result_ = result_ && type_reference_2_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [type_union]
  private static boolean type_reference_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_reference_2_1")) return false;
    type_union(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean type_single_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = type_atom(builder_, level_ + 1);
  ...
  private static boolean type_single_1_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "type_single_1_1", pos_)) break;
    }
    return true;
  }
  ...
  //                       | DOT CLASS
  static boolean type_suffix(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = parseTokens(builder_, 0, DOT, CLASS);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean type_suffix_3_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = consumeToken(builder_, INTEGER_LITERAL);
    if (!result_) result_ = type_path(builder_, level_ + 1);
    return result_;
  }
  ...
  /* ********************************************************** */
  // (PLUS | MINUS | TILDE | STAR | CARET | BANG) unary_expression
  //                            | &<<isBlockPassAllowed>> AMPERSAND unary_expression
  //                            | &<<isWrapUnaryAllowed>> (WRAP_PLUS | WRAP_MINUS) unary_expression
  //                             | postfix_expression
  ...
  // PLUS | MINUS | TILDE | STAR | CARET | BANG
  ...
  private static boolean unary_expression_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = unary_expression_1_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, AMPERSAND);
    result_ = result_ && unary_expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // &<<isBlockPassAllowed>>
  private static boolean unary_expression_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "unary_expression_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isBlockPassAllowed(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  private static boolean unary_expression_2(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = unary_expression_2_0(builder_, level_ + 1);
    result_ = result_ && unary_expression_2_1(builder_, level_ + 1);
    result_ = result_ && unary_expression(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isWrapUnaryAllowed>>
  private static boolean unary_expression_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "unary_expression_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = isWrapUnaryAllowed(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // WRAP_PLUS | WRAP_MINUS
  private static boolean unary_expression_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "unary_expression_2_1")) return false;
    boolean result_;
    result_ = consumeToken(builder_, WRAP_PLUS);
    if (!result_) result_ = consumeToken(builder_, WRAP_MINUS);
    return result_;
  ...
  /* ********************************************************** */
  // WHEN when_entry_list then_clause statement_list
  public static boolean when_clause(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, WHEN);
    result_ = result_ && when_entry_list(builder_, level_ + 1);
    result_ = result_ && then_clause(builder_, level_ + 1);
    result_ = result_ && statement_list(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // multi_assignment | assignment | expression
  static boolean when_condition_entry(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "when_condition_entry")) return false;
    boolean result_;
    result_ = multi_assignment(builder_, level_ + 1);
    if (!result_) result_ = assignment(builder_, level_ + 1);
    if (!result_) result_ = expression(builder_, level_ + 1);
  ...
  public static boolean yield_expression(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && yield_expression_args(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  static boolean yield_expression_args(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = yield_expression_args_0(builder_, level_ + 1);
    if (!result_) result_ = yield_expression_args_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean yield_expression_args_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = yield_expression_args_0_0(builder_, level_ + 1);
    result_ = result_ && yield_expression_args_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // (COMMA NLS expression)*
  private static boolean yield_expression_args_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "yield_expression_args_0_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!yield_expression_args_0_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "yield_expression_args_0_1", pos_)) break;
    }
    return true;
  }

  // COMMA NLS expression
  private static boolean yield_expression_args_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "yield_expression_args_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && NLS(builder_, level_ + 1);
  ...
  // LPAREN argument_list RPAREN
  private static boolean yield_expression_args_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "yield_expression_args_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && argument_list(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // YIELD [LPAREN argument_list RPAREN | bare_argument_list] [postfix_modifier] [heredoc_bodies]
  public static boolean yield_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, yield_statement_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && yield_statement_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // [heredoc_bodies]
  private static boolean yield_statement_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "yield_statement_3")) return false;
    heredoc_bodies(builder_, level_ + 1);
    return true;
  }

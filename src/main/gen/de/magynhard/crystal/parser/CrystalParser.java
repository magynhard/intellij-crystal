...
public class CrystalParser implements PsiParser, LightPsiParser {
  ...
  //                          | (IDENTIFIER | CONSTANT | SELECT) !LBRACKET bare_argument_list [block]
  ...
  //               | SELF DOT (IDENTIFIER | CONSTANT | operator_method_name | macro_interpolation)
  //               | macro_interpolation
  //               | SELECT
  ...
  // IDENTIFIER | CONSTANT | operator_method_name | macro_interpolation
